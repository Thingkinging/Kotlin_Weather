...
import com.kwh.weather_v1.BaseApplication
import com.kwh.weather_v1.databinding.ActivityMainBinding
import com.kwh.weather_v1.ui.viewmodel.WeatherViewModel
import com.kwh.weather_v1.ui.viewmodel.WeatherViewModelFactory
import com.kwh.weather_v1.util.LocationUtils
    ...
    private fun observeBindWeatherData() {
        weatherViewModel.weatherData.observe(this) {
            activityMainBinding.bgImage.setImageDrawable(
                AppCompatResources.getDrawable(this, it.background)
            )
